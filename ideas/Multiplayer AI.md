...
A collaborative real-time workspace canvas (Figma-for-Agents) where multiple users can watch long-running AI task graphs, pause execution mid-flight, supply human-in-the-loop corrections, and pass control across team members via shareable URLs.
